        ...
        if message["type"] == "websocket.accept":
            ...
            if message.get("text") is not None:
                ...
                if message["text"] == "1":
                    ...
                    data = self.websocket.send(
                        wsproto.events.TextMessage(data = "Sorry I am not your peer. I cannot send you Files.")
                    )
                elif message["text"] == "Can you please provide me a list of active peers.":
                    peers = ""
                    ...
                    print("list of peers where i am getting error",list_of_peers)
                    want_to_leave = str(list_23[1])+";"+str(list_23[2])
                    count_of_removing_clients = list_of_peers.count(want_to_leave)
                    ...
                    data_to_be_in_csv = str(list_of_send_data[1])+";"+str(list_of_send_data[2])
                    ...
                    data = self.websocket.send(
                        wsproto.events.TextMessage(data = "Ok. You are Registered.")
                    )
